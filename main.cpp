...
void drawText()
{
	...
	glColor3f(0, 0, 1);
	glRasterPos3f(125, line1, 0);
	printString("TOWER OF HANOI ");
}
...
{
	int menuees = glutCreateMenu(processMenuNumDisks);
	...
	int speedmenu = glutCreateMenu(processspeedmenu);
	...
	glutAddSubMenu("No of Disks", menuees);
	glutAddSubMenu("Speed of solving", speedmenu);
...
void first()
{
	...
	glColor3f(0, 1, 0);
	strokeString(350, 850, 0.15, 0.15, "CMR INSTITUTE OF TECHNOLOGY", 2);
	glColor3f(1, 0, 1);
	strokeString(250, 750, 0.15, 0.15, "DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING", 2);
	glColor3f(1, 0.5, 0);
	strokeString(200, 650, 0.15, 0.15, "18CSL67-COMPUTER GRAPHICS WITH MINI PROJECT LABORATORY", 2);
	glColor3f(0, 0, 0.5);
	strokeString(0, 590, 0.1, 0.1, "===============================================================================================================", 2);
	glColor3f(0, 0, 1);
	strokeString(250, 480, 0.4, 0.4, "TOWER OF HANOI", 2);
	glColor3f(1, 1, 0);
	strokeString(150, 400, 0.15, 0.15, "CREATED BY", 2);
	glColor3f(1, 1, 0);
	strokeString(600, 400, 0.15, 0.15, "GUIDED BY", 2);
	glColor3f(0, 0.5, 0);
	strokeString(150, 350, 0.15, 0.15, "NAUMAN N ISLAMPUR(1CR20CS218)", 2);
	glColor3f(0, 0.5, 0);
	strokeString(150, 300, 0.15, 0.15, "PRANAV BHUJU(1CR20CS139)", 2);
	glColor3f(0, 0.5, 0);
	strokeString(600, 350, 0.15, 0.15, "Dr.V N Manju, Assistant Professor", 2);
	strokeString(600, 300, 0.15, 0.15, "Mr.Shivraj V B, Assistant Professor", 2);
	glColor3f(1, 1, 0);
	strokeString(400, 100, 0.15, 0.15, "Press <<ENTER>> to Begin", 2);
	glutSwapBuffers();
}
...
// codeblocks ma build and run option use garne